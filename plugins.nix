...
{
  description = "Plugins for Neovim config.";
  ...
  outputs = inputs @ { self, flake-utils, nixpkgs, ... }:
    ...
    let
      inherit (nixpkgs.legacyPackages.${system}) vimPlugins vimUtils; # TODO: do we want this? legacy?
      ...
      # TODO: what is this, do i need this? i think its `remap.lua`, `set.lua`, etc.
      # lua-modules = vimUtils.buildVimPlugin {
      #   pname = "lua-modules";
      #   src = ./lua;
      #   version = "local";
      # };
